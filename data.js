 ...
 * ------------------------
 * The textbook and sample exams assess more than the items explicitly printed
 * under “Key Terms and Concepts”. These entries also cover vocabulary from
 * readings, case studies and exercises, including verbs, adjectives, phrasal
 * verbs and recurring academic/business collocations.
 * Tuple format: [term, English definition, Vietnamese meaning, part of speech, source]
 */
const ESP3_EXTENDED_VOCABULARY = {
  "unit-1": [
    ["Internationalization", "The extension of a firm's or country's economic activities across national borders.", "quốc tế hóa", "NOUN", "CORE / GAP FILLING"],
    ["FDI flow", "The amount of foreign direct investment entering or leaving a country during a stated period.", "dòng vốn FDI trong một giai đoạn", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["FDI stock", "The accumulated value of foreign direct investment held at a particular point in time.", "lượng vốn FDI tích lũy", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Portfolio investment", "Investment in foreign financial assets without seeking managerial control of the issuing business.", "đầu tư gián tiếp", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Invention", "A new idea, design, product or process, whether or not it has been commercially applied.", "phát minh", "NOUN", "CORE / GAP FILLING"],
    ["Technology", "The accumulated knowledge and innovations used to produce goods or services.", "công nghệ", "NOUN", "CORE / GAP FILLING"],
    ["Outsourcing", "Arranging for an external organization to perform an activity previously or potentially done in-house.", "thuê ngoài", "GERUND", "CORE / GAP FILLING"],
    ["Offshoring", "Relocating a business activity to another country, within the firm or through an external supplier.", "chuyển hoạt động ra nước ngoài", "GERUND", "CORE / GAP FILLING"],
    ["Nearshoring", "Relocating a business activity to a nearby foreign country.", "chuyển hoạt động sang nước lân cận", "GERUND", "CORE / GAP FILLING"],
    ["Global production network (GPN)", "A cross-border network of firms and other actors that create, transform and capture value.", "mạng lưới sản xuất toàn cầu", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Producer-driven value chain", "A value chain led by manufacturers that control technology, design and major production decisions.", "chuỗi giá trị do nhà sản xuất dẫn dắt", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Buyer-driven value chain", "A value chain led by retailers or brand owners that coordinate independent suppliers.", "chuỗi giá trị do người mua dẫn dắt", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Standardization", "The use of substantially the same product or business approach across different markets.", "tiêu chuẩn hóa", "NOUN", "CORE / GAP FILLING"],
    ["Adaptation", "The modification of a product or business practice to suit a local market.", "thích nghi hóa", "NOUN", "CORE / GAP FILLING"],
    ["Small and medium-sized enterprise (SME)", "A business classified as small or medium according to criteria such as employees, revenue or investment.", "doanh nghiệp nhỏ và vừa", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Flagship firm", "A leading company that coordinates important activities and relationships in a production network.", "doanh nghiệp chủ lực", "NOUN PHRASE", "READING / CASE STUDY"],
    ["Economies of scale", "Reductions in average cost achieved when output is produced on a larger scale.", "lợi thế kinh tế theo quy mô", "NOUN PHRASE", "READING / CASE STUDY"],
    ["Outsource", "To contract an external organization to perform a business activity.", "thuê ngoài một hoạt động", "VERB", "READING / CASE STUDY"],
    ["Offshore", "To move a business activity to another country.", "chuyển hoạt động ra nước ngoài", "VERB", "READING / CASE STUDY"],
    ["Retain a competitive advantage", "To continue possessing an advantage over competitors.", "duy trì lợi thế cạnh tranh", "COLLOCATION", "READING / CASE STUDY"],
    ["Address a business problem", "To deal with or attempt to solve a difficulty facing a business.", "xử lý một vấn đề kinh doanh", "COLLOCATION", "READING / CASE STUDY"],
    ["Comply with local law", "To act according to the laws and regulations of the host country.", "tuân thủ luật pháp địa phương", "COLLOCATION", "READING / CASE STUDY"],
    ["Offset risk", "To counterbalance or reduce the effect of a risk.", "bù đắp hoặc giảm rủi ro", "COLLOCATION", "READING / CASE STUDY"],
    ["Tailor a product", "To modify a product for the needs of a particular group or market.", "điều chỉnh sản phẩm cho phù hợp", "COLLOCATION", "READING / CASE STUDY"],
    ["Undercut a competitor", "To offer a lower price than a competitor.", "bán thấp giá hơn đối thủ", "COLLOCATION", "READING / CASE STUDY"],
    ["Price-conscious", "Careful about prices and strongly influenced by them when buying.", "nhạy cảm về giá", "ADJECTIVE", "READING / CASE STUDY"],
    ["Disposable income", "Income available for spending or saving after direct taxes have been paid.", "thu nhập khả dụng", "NOUN PHRASE", "READING / CASE STUDY"],
    ["Fragmented market", "A market divided among many relatively small competitors or customer groups.", "thị trường phân mảnh", "NOUN PHRASE", "READING / CASE STUDY"],
    ["Maintain a foothold", "To preserve a secure initial position in a market from which further growth is possible.", "duy trì vị thế ban đầu", "COLLOCATION", "READING / CASE STUDY"],
    ["Hiatus", "A temporary pause or interruption in an activity.", "thời gian gián đoạn", "NOUN", "READING / CASE STUDY"]
  ],
  "unit-2": [
    ["Exporting", "Selling goods or services produced in one country to customers in another country.", "hoạt động xuất khẩu", "GERUND", "CORE / GAP FILLING"],
    ["Theory of absolute advantage", "The theory that countries gain by specializing in goods they can produce more efficiently than others.", "lý thuyết lợi thế tuyệt đối", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Importing", "Buying goods or services produced in another country.", "hoạt động nhập khẩu", "GERUND", "CORE / GAP FILLING"],
    ["Theory of comparative advantage", "The theory that countries gain by specializing according to their lower opportunity costs.", "lý thuyết lợi thế so sánh", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Loan guarantee", "A government or institutional promise to repay a lender if an exporter fails to do so.", "bảo lãnh khoản vay", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["International product life cycle theory", "A theory explaining how the location of production and trade changes as a product matures.", "lý thuyết vòng đời sản phẩm quốc tế", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["World Trade Organization (WTO)", "The international organization that administers trade agreements and provides a system for settling trade disputes.", "Tổ chức Thương mại Thế giới", "PROPER NOUN", "CORE / GAP FILLING"],
    ["General Agreement on Tariffs and Trade (GATT)", "The multilateral agreement created to reduce tariffs and other barriers to international trade.", "Hiệp định chung về Thuế quan và Thương mại", "PROPER NOUN", "CORE / GAP FILLING"],
    ["Commodities", "Basic goods or raw materials that are traded, often in standardized grades.", "hàng hóa cơ bản", "PLURAL NOUN", "CORE / GAP FILLING"],
    ["Primary products", "Products obtained directly from agriculture, forestry, fishing or extractive industries.", "sản phẩm sơ cấp", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Primary", "Obtained directly from agriculture or extractive activity rather than manufacturing.", "thuộc khu vực sơ cấp; nguyên khai", "ADJECTIVE", "CORE / GAP FILLING"],
    ["Terms of trade", "The ratio between a country's export prices and import prices.", "tỷ lệ trao đổi thương mại", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Export tariff", "A tax imposed on goods as they leave a country.", "thuế xuất khẩu", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Import tariff", "A tax imposed on goods entering a country.", "thuế nhập khẩu", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Ad valorem tariff", "A tariff calculated as a percentage of the imported product's value.", "thuế theo tỷ lệ giá trị", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Ad valorem", "Calculated as a percentage of the value of the imported product.", "tính theo tỷ lệ phần trăm giá trị", "ADJECTIVE", "CORE / GAP FILLING"],
    ["Specific tariff", "A fixed tax charged per physical unit of an imported product.", "thuế tuyệt đối theo đơn vị", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Compound tariff", "A tariff combining an ad valorem charge with a specific charge.", "thuế hỗn hợp", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Invisible trade", "International trade in services and income flows rather than tangible goods.", "thương mại vô hình", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Factors of production", "Resources used to produce goods and services, commonly land, labour, capital and entrepreneurship.", "các yếu tố sản xuất", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Visible trade", "International trade in tangible goods that physically cross borders.", "thương mại hữu hình", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Division of labour", "The allocation of different production tasks to different workers, firms or countries.", "phân công lao động", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Economies of scale", "Cost advantages gained when a firm or industry produces on a larger scale.", "lợi thế kinh tế theo quy mô", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Administrative delay", "A non-tariff barrier that slows imports through time-consuming procedures.", "trì hoãn hành chính", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Foreign exchange control", "Government restrictions on the purchase, sale or use of foreign currencies.", "kiểm soát ngoại hối", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Buy-national restriction", "A rule or policy favouring domestically produced goods in purchasing decisions.", "quy định ưu tiên mua hàng nội địa", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Special government agency", "A public organization established to provide exporters with information, finance or other support.", "cơ quan chính phủ chuyên trách", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Cartel", "A group of independent producers that cooperate to control output, prices or markets.", "các-ten; liên minh kiểm soát giá hoặc sản lượng", "NOUN", "CORE / GAP FILLING"],
    ["Barter", "The direct exchange of goods or services without using money.", "hàng đổi hàng", "NOUN", "CORE / GAP FILLING"],
    ["Countertrade", "International trade in which the seller accepts goods, services or other reciprocal commitments as payment.", "thương mại đối lưu", "NOUN", "CORE / GAP FILLING"],
    ["Transit tariff", "A tax imposed on goods passing through a country on the way to another destination.", "thuế quá cảnh", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Default on repayment", "To fail to repay a loan according to the agreed terms.", "không thực hiện nghĩa vụ trả nợ", "VERB PHRASE", "VOCABULARY EXERCISE"],
    ["Stifle imports", "To restrict or suppress the flow of imported goods.", "kìm hãm nhập khẩu", "COLLOCATION", "VOCABULARY EXERCISE"],
    ["Accumulate wealth", "To build up wealth gradually over time.", "tích lũy của cải", "COLLOCATION", "READING / CASE STUDY"],
    ["Specialize in", "To concentrate production or expertise on a limited range of goods, services or activities.", "chuyên môn hóa về", "VERB PHRASE", "READING / CASE STUDY"]
  ],
  "unit-3": [
    ["Positive-sum game", "A situation in which all participants can obtain net benefits.", "trò chơi tổng dương", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Globalization", "The increasing integration and interdependence of markets, production and economic actors worldwide.", "toàn cầu hóa", "NOUN", "CORE / GAP FILLING"],
    ["Mercantilism", "A doctrine favouring exports and trade surpluses as a means of accumulating national wealth.", "chủ nghĩa trọng thương", "NOUN", "CORE / GAP FILLING"],
    ["Code of conduct", "A written set of principles or rules governing acceptable behaviour.", "bộ quy tắc ứng xử", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Internationalization", "The extension of economic activities across national borders.", "quốc tế hóa", "NOUN", "CORE / GAP FILLING"],
    ["Infant industry argument", "The claim that new domestic industries need temporary protection until they become competitive.", "lập luận ngành công nghiệp non trẻ", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Globalization of markets", "The process through which formerly separate national markets become increasingly integrated.", "toàn cầu hóa thị trường", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Subsidy", "Financial support granted by a government to reduce costs or encourage an activity.", "trợ cấp", "NOUN", "CORE / GAP FILLING"],
    ["Tax haven", "A jurisdiction offering very low taxes and often financial secrecy to non-residents.", "thiên đường thuế", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Anti-dumping laws", "Rules allowing action against imports sold below normal value when they cause material injury.", "luật chống bán phá giá", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Horizontal FDI", "Foreign direct investment in the same industry and stage of production as the investor's home operation.", "FDI theo chiều ngang", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Common market", "An integration arrangement permitting free movement of goods, services, capital and labour among members.", "thị trường chung", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Mixed economy", "An economy combining private market activity with significant government intervention or ownership.", "nền kinh tế hỗn hợp", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Minimum efficient scale", "The lowest output level at which a firm can achieve the minimum long-run average cost.", "quy mô hiệu quả tối thiểu", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Capital account", "The balance-of-payments account for capital transfers and non-produced, non-financial assets; some textbook exercises use the term more broadly.", "tài khoản vốn", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Price elasticity of demand", "The responsiveness of quantity demanded to a change in price.", "độ co giãn của cầu theo giá", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Polycentric staffing", "A staffing policy in which foreign subsidiaries are mainly managed by host-country nationals.", "chính sách nhân sự đa tâm", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Local content requirement", "A rule requiring a stated share of a product's value or inputs to be produced locally.", "yêu cầu hàm lượng nội địa", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Multilateralism", "Cooperation or rule-making involving several countries on a non-exclusive basis.", "chủ nghĩa đa phương", "NOUN", "CORE / GAP FILLING"],
    ["Voluntary export restraint", "An agreement by an exporting country to limit shipments to another country.", "hạn chế xuất khẩu tự nguyện", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Competition laws", "Rules intended to prevent anti-competitive conduct and protect market competition.", "luật cạnh tranh", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Floating exchange rate", "An exchange rate mainly determined by supply and demand in the foreign exchange market.", "tỷ giá thả nổi", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["General Agreement on Tariffs and Trade (GATT)", "The multilateral agreement that established rules and negotiations for reducing trade barriers.", "Hiệp định chung về Thuế quan và Thương mại", "PROPER NOUN", "CORE / GAP FILLING"],
    ["Transparency", "The quality of making trade rules, decisions and procedures clear and accessible.", "tính minh bạch", "NOUN", "CORE / GAP FILLING"],
    ["Countervailing duty", "A duty imposed to offset the injurious effect of a foreign government subsidy.", "thuế chống trợ cấp", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Trade remedy", "A legally permitted measure responding to unfair trade or serious injury from imports.", "biện pháp phòng vệ thương mại", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Non-tariff measure", "A policy measure other than a tariff that can affect the quantity, price or conditions of trade.", "biện pháp phi thuế quan", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["WTO dispute settlement", "The WTO process used by members to resolve disputes about trade obligations.", "cơ chế giải quyết tranh chấp WTO", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Double-entry accounting", "A recording system in which each balance-of-payments transaction generates offsetting credit and debit entries.", "kế toán ghi sổ kép", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Current transfer", "A one-way current-account payment with no corresponding good, service or asset received.", "chuyển giao vãng lai", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Market access", "The conditions determining whether and how foreign goods or services may enter a market.", "tiếp cận thị trường", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Consumer welfare", "The well-being consumers obtain from price, quality, choice and availability in a market.", "phúc lợi người tiêu dùng", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Adhere to", "To follow or comply with a rule, agreement or principle.", "tuân thủ", "PHRASAL VERB", "VOCABULARY EXERCISE"],
    ["Accede to an agreement", "To formally become a party to an international agreement.", "gia nhập một hiệp định", "COLLOCATION", "VOCABULARY EXERCISE"],
    ["Liberalize trade", "To reduce government restrictions on international trade.", "tự do hóa thương mại", "COLLOCATION", "READING / CASE STUDY"],
    ["Protect domestic producers", "To shield local firms from foreign competition through government measures.", "bảo hộ nhà sản xuất trong nước", "COLLOCATION", "READING / CASE STUDY"],
    ["Non-discriminatory", "Applying equally without favouring one trading partner or product over another.", "không phân biệt đối xử", "ADJECTIVE", "READING / CASE STUDY"],
    ["Predictable", "Stable and sufficiently clear for businesses to anticipate future conditions.", "có thể dự đoán", "ADJECTIVE", "READING / CASE STUDY"]
  ],
  "unit-4": [
    ["Investment incentives", "Government benefits designed to attract or influence investment projects.", "các ưu đãi đầu tư", "PLURAL NOUN", "CORE / GAP FILLING"],
    ["Royalty payments", "Payments made for the right to use intellectual property, natural resources or another owner's asset.", "các khoản tiền bản quyền", "PLURAL NOUN", "CORE / GAP FILLING"],
    ["Decentralization", "The delegation of decision-making authority from headquarters to lower levels or foreign subsidiaries.", "phi tập trung hóa", "NOUN", "CORE / GAP FILLING"],
    ["Centralization", "The concentration of decision-making authority at headquarters or a senior organizational level.", "tập trung hóa", "NOUN", "CORE / GAP FILLING"],
    ["Greenfield investment", "FDI that establishes a new operation or facility from the ground up in a host country.", "đầu tư mới hoàn toàn", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Multinational corporation", "A corporation that owns or controls value-adding activities in more than one country.", "công ty đa quốc gia", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Licensor", "The owner that grants another party the right to use specified intellectual property.", "bên cấp phép", "NOUN", "CORE / GAP FILLING"],
    ["Licensee", "The party receiving the contractual right to use specified intellectual property.", "bên được cấp phép", "NOUN", "CORE / GAP FILLING"],
    ["Wholly owned subsidiary", "A foreign business whose equity is entirely owned by its parent company.", "công ty con sở hữu toàn bộ", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Conglomerate merger", "A merger between firms operating in unrelated industries.", "sáp nhập hỗn hợp khác ngành", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Congeneric merger", "A merger between firms in the same broad industry with related products, markets or technology.", "sáp nhập đồng tâm", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Market-extension merger", "A merger between firms selling similar products in different geographic markets.", "sáp nhập mở rộng thị trường", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Friendly acquisition", "An acquisition approved and supported by the target company's management or board.", "mua lại thân thiện", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Reverse acquisition", "An acquisition in which a private company obtains a public company, often to gain a stock-market listing.", "mua lại ngược", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Back-flip acquisition", "An acquisition after which the acquiring company becomes a subsidiary of the purchased company.", "mua lại đảo chiều", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Hostile acquisition", "An acquisition pursued without the consent of the target company's management.", "mua lại thù địch", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Expected return", "The profit or loss an investor anticipates from an investment.", "lợi nhuận kỳ vọng", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Set up a subsidiary", "To establish a company controlled by a parent business.", "thành lập công ty con", "COLLOCATION", "VOCABULARY EXERCISE"],
    ["Train local workers", "To develop the skills and knowledge of employees in the host country.", "đào tạo lao động địa phương", "COLLOCATION", "VOCABULARY EXERCISE"],
    ["Dominate a sector", "To hold a leading or controlling position in an industry.", "chi phối một ngành", "COLLOCATION", "VOCABULARY EXERCISE"],
    ["Employ local workers", "To hire people from the host-country labour market.", "tuyển dụng lao động địa phương", "COLLOCATION", "VOCABULARY EXERCISE"],
    ["Bring out a product", "To introduce or launch a product on the market.", "tung sản phẩm ra thị trường", "PHRASAL VERB", "VOCABULARY EXERCISE"],
    ["Gain control", "To obtain the authority to direct a company's operations or decisions.", "giành quyền kiểm soát", "COLLOCATION", "READING / CASE STUDY"],
    ["Asset stripping", "Buying a company and selling its assets separately, often for short-term gain.", "bán tháo tài sản doanh nghiệp sau mua lại", "NOUN PHRASE", "READING / CASE STUDY"],
    ["Target company", "The company that another firm seeks to acquire.", "công ty mục tiêu", "NOUN PHRASE", "READING / CASE STUDY"],
    ["Working capital", "Short-term funds available for a business's day-to-day operations.", "vốn lưu động", "NOUN PHRASE", "READING / CASE STUDY"],
    ["Cash grant", "A direct payment made by a government to support an investment project.", "trợ cấp tiền mặt", "NOUN PHRASE", "READING / CASE STUDY"],
    ["Accelerated depreciation", "A tax provision allowing an asset's cost to be deducted more rapidly in its early years.", "khấu hao nhanh", "NOUN PHRASE", "READING / CASE STUDY"],
    ["Interest rebate", "A refund or reduction of interest costs offered as an investment incentive.", "hoàn hoặc giảm lãi vay", "NOUN PHRASE", "READING / CASE STUDY"],
    ["Market share", "A firm's sales as a percentage of total sales in a defined market.", "thị phần", "NOUN PHRASE", "READING / CASE STUDY"]
  ],
  "unit-5": [
    ["Convert a currency", "To exchange one currency for another.", "chuyển đổi một loại tiền tệ", "COLLOCATION", "VOCABULARY EXERCISE"],
    ["Quote an exchange rate", "To state the price of one currency in terms of another.", "niêm yết tỷ giá", "COLLOCATION", "VOCABULARY EXERCISE"],
    ["Appreciate", "For a currency, to increase in value relative to another currency.", "tăng giá", "VERB", "READING / CASE STUDY"],
    ["Depreciate", "For a currency, to decrease in value relative to another currency.", "giảm giá", "VERB", "READING / CASE STUDY"],
    ["Fluctuate", "To rise and fall irregularly in value.", "biến động", "VERB", "READING / CASE STUDY"],
    ["Intervene in the foreign exchange market", "For a central bank to buy or sell currencies to influence an exchange rate.", "can thiệp vào thị trường ngoại hối", "COLLOCATION", "READING / CASE STUDY"],
    ["Buy low and sell high", "To make a profit by purchasing an asset cheaply and selling it at a higher price.", "mua thấp bán cao", "COLLOCATION", "VOCABULARY EXERCISE"],
    ["Lock in an exchange rate", "To fix an exchange rate in advance for a future transaction.", "khóa tỷ giá", "COLLOCATION", "VOCABULARY EXERCISE"],
    ["Mitigate currency risk", "To reduce potential losses caused by exchange-rate movements.", "giảm thiểu rủi ro tiền tệ", "COLLOCATION", "VOCABULARY EXERCISE"],
    ["Prospective buyer", "A person or organization that may buy a currency, product or asset.", "người mua tiềm năng", "NOUN PHRASE", "READING / CASE STUDY"],
    ["Currency dealer", "A person or financial institution that buys and sells currencies.", "nhà kinh doanh ngoại tệ", "NOUN PHRASE", "READING / CASE STUDY"],
    ["Cross rate", "An exchange rate between two currencies calculated from their rates against a third currency.", "tỷ giá chéo", "NOUN PHRASE", "READING / CASE STUDY"],
    ["Devaluation", "An official reduction in a currency's value under a fixed exchange-rate system.", "phá giá tiền tệ", "NOUN", "READING / CASE STUDY"],
    ["Revaluation", "An official increase in a currency's value under a fixed exchange-rate system.", "nâng giá tiền tệ", "NOUN", "READING / CASE STUDY"],
    ["Exchange-rate exposure", "The extent to which exchange-rate changes can affect a firm's value or cash flows.", "mức độ phơi nhiễm tỷ giá", "NOUN PHRASE", "READING / CASE STUDY"]
  ],
  "unit-6": [
    ["Remit payment", "To send money to another person or organization, especially across borders.", "chuyển tiền thanh toán", "COLLOCATION", "VOCABULARY EXERCISE"],
    ["Issue a letter of credit", "For a bank to create a documentary credit at an applicant's request.", "phát hành thư tín dụng", "COLLOCATION", "VOCABULARY EXERCISE"],
    ["Advise a letter of credit", "For a bank to authenticate and notify the beneficiary of a letter of credit.", "thông báo thư tín dụng", "COLLOCATION", "VOCABULARY EXERCISE"],
    ["Confirm a letter of credit", "For a second bank to add its own payment undertaking to an issuing bank's credit.", "xác nhận thư tín dụng", "COLLOCATION", "VOCABULARY EXERCISE"],
    ["Honour a draft", "To pay or accept a draft in accordance with its terms.", "thanh toán hoặc chấp nhận hối phiếu", "COLLOCATION", "VOCABULARY EXERCISE"],
    ["Draw a bill", "To create and sign a bill of exchange ordering another party to pay.", "ký phát hối phiếu", "COLLOCATION", "VOCABULARY EXERCISE"],
    ["Accept a bill", "For the drawee to sign a bill of exchange and undertake to pay it at maturity.", "chấp nhận hối phiếu", "COLLOCATION", "VOCABULARY EXERCISE"],
    ["Endorse a bill", "To sign and transfer rights under a bill of exchange to another party.", "ký hậu hối phiếu", "COLLOCATION", "VOCABULARY EXERCISE"],
    ["Present documents", "To submit the required commercial and transport documents to a bank or buyer.", "xuất trình chứng từ", "COLLOCATION", "VOCABULARY EXERCISE"],
    ["Release documents", "To make trade documents available to the buyer after stated conditions are met.", "giao bộ chứng từ", "COLLOCATION", "VOCABULARY EXERCISE"],
    ["Comply with terms and conditions", "To satisfy all requirements stated in a contract or letter of credit.", "tuân thủ các điều khoản và điều kiện", "COLLOCATION", "READING / CASE STUDY"],
    ["Default on payment", "To fail to make a payment when it is due.", "không thực hiện nghĩa vụ thanh toán", "VERB PHRASE", "READING / CASE STUDY"],
    ["Collect payment", "To obtain money owed by a buyer or other debtor.", "thu tiền thanh toán", "COLLOCATION", "READING / CASE STUDY"],
    ["Document of title", "A document representing ownership of goods and enabling the holder to claim or transfer them.", "chứng từ sở hữu hàng hóa", "NOUN PHRASE", "READING / CASE STUDY"],
    ["Drawee", "The party directed by a bill of exchange to make payment.", "người bị ký phát", "NOUN", "READING / CASE STUDY"],
    ["Drawer", "The party that creates and signs a bill of exchange.", "người ký phát", "NOUN", "READING / CASE STUDY"],
    ["Payee", "The person or organization to whom payment is to be made.", "người thụ hưởng", "NOUN", "READING / CASE STUDY"],
    ["Negotiate documents", "For a nominated bank to purchase complying documents or drafts under a letter of credit.", "chiết khấu hoặc thương lượng bộ chứng từ", "COLLOCATION", "READING / CASE STUDY"]
  ],
  "unit-7": [
    ["Market penetration", "A strategy of increasing sales of existing products in existing markets.", "thâm nhập thị trường", "NOUN PHRASE", "READING / CASE STUDY"],
    ["Market skimming", "A pricing strategy that begins with a high price to earn revenue from customers willing to pay more.", "định giá hớt váng", "NOUN PHRASE", "READING / CASE STUDY"],
    ["Early adopter", "A customer who begins using a new product before most other people.", "người chấp nhận sản phẩm sớm", "NOUN PHRASE", "READING / CASE STUDY"],
    ["Differentiate a product", "To make a product meaningfully distinct from competing offerings.", "khác biệt hóa sản phẩm", "COLLOCATION", "VOCABULARY EXERCISE"],
    ["Reach saturation", "For a market to reach a point at which most potential buyers already own or use the product.", "đạt mức bão hòa", "COLLOCATION", "READING / CASE STUDY"],
    ["Withdraw from the market", "To stop selling a product or operating in a market.", "rút khỏi thị trường", "VERB PHRASE", "READING / CASE STUDY"],
    ["Line filling", "Adding products within an existing product line to cover gaps or reach more customers.", "bổ sung mặt hàng vào dòng sản phẩm", "NOUN PHRASE", "READING / CASE STUDY"],
    ["List price", "The publicly stated price before discounts or negotiations.", "giá niêm yết", "NOUN PHRASE", "VOCABULARY EXERCISE"],
    ["Quantity discount", "A price reduction given for purchasing a large amount.", "chiết khấu theo số lượng", "NOUN PHRASE", "VOCABULARY EXERCISE"],
    ["Prestige pricing", "Setting a high price to signal superior quality or exclusivity.", "định giá uy tín", "NOUN PHRASE", "VOCABULARY EXERCISE"],
    ["Personal selling", "Direct communication by a salesperson to persuade a customer to buy.", "bán hàng cá nhân", "NOUN PHRASE", "VOCABULARY EXERCISE"],
    ["Public relations", "Managing communication and relationships between an organization and its publics.", "quan hệ công chúng", "NOUN PHRASE", "VOCABULARY EXERCISE"],
    ["Sponsorship", "Financial or material support provided in return for promotional association.", "tài trợ", "NOUN", "VOCABULARY EXERCISE"],
    ["Packaging", "The design and production of a product's container or wrapping.", "bao bì và hoạt động đóng gói", "NOUN", "VOCABULARY EXERCISE"],
    ["Inventory", "Goods and materials held for production or sale.", "hàng tồn kho", "NOUN", "VOCABULARY EXERCISE"],
    ["Retailing", "Selling goods or services directly to final consumers.", "bán lẻ", "GERUND", "VOCABULARY EXERCISE"],
    ["Wholesaling", "Selling goods in quantity to retailers or business users rather than final consumers.", "bán buôn", "GERUND", "VOCABULARY EXERCISE"],
    ["Warehousing", "Storing goods until they are needed for production, distribution or sale.", "lưu kho", "GERUND", "VOCABULARY EXERCISE"],
    ["Vending machine", "A self-service machine that supplies products after payment.", "máy bán hàng tự động", "NOUN PHRASE", "READING / CASE STUDY"],
    ["Consumer taste", "The preferences that influence what consumers choose to buy.", "thị hiếu người tiêu dùng", "NOUN PHRASE", "READING / CASE STUDY"],
    ["Product life cycle", "The stages a product passes through from introduction to growth, maturity and decline.", "vòng đời sản phẩm", "NOUN PHRASE", "READING / CASE STUDY"]
  ],
  "unit-8": [
    ["Spur economic growth", "To stimulate or accelerate an increase in economic activity and output.", "thúc đẩy tăng trưởng kinh tế", "COLLOCATION", "READING / CASE STUDY"],
    ["Logistics outsourcing", "Contracting an external provider to perform logistics activities.", "thuê ngoài dịch vụ logistics", "NOUN PHRASE", "READING / CASE STUDY"],
    ["Logistics cost", "The cost of transportation, storage, inventory, handling and related logistics activities.", "chi phí logistics", "NOUN PHRASE", "READING / CASE STUDY"],
    ["Logistics Performance Index (LPI)", "A World Bank indicator comparing countries' trade-logistics performance.", "chỉ số năng lực logistics", "NOUN PHRASE", "READING / CASE STUDY"],
    ["Logistics infrastructure", "Transport, warehousing, information and other facilities supporting the movement of goods.", "cơ sở hạ tầng logistics", "NOUN PHRASE", "READING / CASE STUDY"],
    ["Service provider", "A company that performs services for customers or other businesses.", "nhà cung cấp dịch vụ", "NOUN PHRASE", "READING / CASE STUDY"],
    ["Lag behind", "To develop or perform more slowly than others.", "tụt hậu", "PHRASAL VERB", "READING / CASE STUDY"],
    ["Deliver goods", "To transport and hand goods to the intended recipient.", "giao hàng", "COLLOCATION", "VOCABULARY EXERCISE"],
    ["Freight consolidation", "Combining several smaller shipments into one larger load for transport.", "gom hàng vận chuyển", "NOUN PHRASE", "VOCABULARY EXERCISE"],
    ["Reverse logistics", "The movement of returned, reusable or recyclable products back through the supply chain.", "logistics ngược", "NOUN PHRASE", "VOCABULARY EXERCISE"],
    ["Inventory turnover", "The rate at which inventory is sold or used and replaced during a period.", "vòng quay hàng tồn kho", "NOUN PHRASE", "VOCABULARY EXERCISE"],
    ["Last-mile delivery", "The final stage of transporting an order from a distribution point to the customer.", "giao hàng chặng cuối", "NOUN PHRASE", "VOCABULARY EXERCISE"],
    ["Intermodal transport", "Transport using two or more modes while keeping goods in the same loading unit.", "vận tải đa phương thức", "NOUN PHRASE", "VOCABULARY EXERCISE"],
    ["Third-party logistics (3PL)", "The use of an external specialist to manage logistics activities for a company.", "logistics bên thứ ba", "NOUN PHRASE", "VOCABULARY EXERCISE"],
    ["Order fulfilment", "The complete process of receiving, preparing, dispatching and delivering a customer's order.", "thực hiện đơn hàng", "NOUN PHRASE", "VOCABULARY EXERCISE"],
    ["Warehousing", "The organized storage and handling of goods before they are needed.", "hoạt động lưu kho", "GERUND", "VOCABULARY EXERCISE"],
    ["Traceability", "The ability to track a product, shipment or component through the supply chain.", "khả năng truy xuất", "NOUN", "VOCABULARY EXERCISE"]
  ],
  "unit-9": [
    ["Pooling", "Combining many similar exposure units so losses can be predicted and shared.", "gộp chung rủi ro", "GERUND", "CORE / GAP FILLING"],
    ["Indemnity", "Compensation intended to restore an insured party to approximately the financial position held before a loss.", "sự bồi thường", "NOUN", "CORE / GAP FILLING"],
    ["Representations", "Statements of fact made by an applicant to an insurer before a contract is issued.", "các lời khai của bên mua bảo hiểm", "PLURAL NOUN", "CORE / GAP FILLING"],
    ["Marine insurance", "Insurance covering ships, cargo, freight and related risks of transit.", "bảo hiểm hàng hải", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Particular average", "A partial marine loss borne by the owner of the affected property rather than shared by all interests.", "tổn thất riêng", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["All-risks cover", "Protection against accidental loss or damage except risks specifically excluded by the policy.", "bảo hiểm mọi rủi ro trừ loại trừ", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Willful misconduct", "A deliberate wrongful act by the insured that causes or contributes to a loss.", "hành vi cố ý sai trái", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Wear and tear", "Gradual deterioration resulting from ordinary use rather than an accidental event.", "hao mòn tự nhiên", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Inherent vice", "A natural characteristic or internal defect that causes insured goods to deteriorate or become damaged.", "khuyết tật nội tại", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Ordinary leakage and breakage", "Normal loss of quantity or routine breakage during transit, commonly excluded from cover.", "rò rỉ và vỡ thông thường", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Insurance claim", "A formal request for payment under an insurance policy after a covered loss.", "yêu cầu bồi thường bảo hiểm", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Floating policy", "A policy stating a maximum cover amount while individual shipment details are declared later.", "đơn bảo hiểm bao", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Property insurance", "Insurance protecting buildings, equipment or other physical assets against covered loss or damage.", "bảo hiểm tài sản", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Liability insurance", "Insurance covering legal responsibility for injury or damage suffered by another party.", "bảo hiểm trách nhiệm", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Total loss", "Loss or destruction so complete that the insured property has no recoverable value for the insured purpose.", "tổn thất toàn bộ", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Partial loss", "Damage or loss affecting only part of the insured property's value.", "tổn thất bộ phận", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Carrier", "A person or company contractually responsible for transporting goods or passengers.", "người chuyên chở", "NOUN", "CORE / GAP FILLING"],
    ["Consignee", "The person or organization named to receive a shipment.", "người nhận hàng", "NOUN", "CORE / GAP FILLING"],
    ["Consignor", "The person or organization that sends goods to another party.", "người gửi hàng", "NOUN", "CORE / GAP FILLING"],
    ["Survey report", "A report by an independent expert describing the cause, nature and extent of cargo damage.", "biên bản giám định", "NOUN PHRASE", "CORE / GAP FILLING"],
    ["Indemnify", "To compensate an insured party for a covered financial loss.", "bồi thường", "VERB", "VOCABULARY EXERCISE"],
    ["Submit a claim", "To formally send an insurer a request for compensation and supporting evidence.", "nộp yêu cầu bồi thường", "COLLOCATION", "VOCABULARY EXERCISE"],
    ["Insurance broker", "An intermediary who helps clients arrange insurance coverage with insurers.", "môi giới bảo hiểm", "NOUN PHRASE", "VOCABULARY EXERCISE"],
    ["Link the policy value to the property value", "To connect the amount insured with the value of the property covered.", "gắn giá trị đơn bảo hiểm với giá trị tài sản", "COLLOCATION", "VOCABULARY EXERCISE"],
    ["Admit liability", "To accept legal or contractual responsibility for a loss.", "thừa nhận trách nhiệm", "COLLOCATION", "VOCABULARY EXERCISE"],
    ["Mature (a policy)", "For an insurance policy or investment contract to reach the date when its benefit becomes payable.", "đáo hạn", "VERB", "VOCABULARY EXERCISE"],
    ["Void", "Having no legal effect or no longer valid.", "vô hiệu", "ADJECTIVE", "VOCABULARY EXERCISE"],
    ["Grace period", "Extra time after a premium due date during which coverage may continue without immediate penalty.", "thời gian gia hạn", "NOUN PHRASE", "VOCABULARY EXERCISE"],
    ["Insured against", "Protected by insurance from a specified risk or peril.", "được bảo hiểm trước rủi ro", "ADJECTIVE PHRASE", "VOCABULARY EXERCISE"],
    ["Underwrite a risk", "For an insurer to assess a risk and accept it on stated terms and premium.", "thẩm định và nhận bảo hiểm rủi ro", "COLLOCATION", "READING / CASE STUDY"],
    ["Reinsurance", "Insurance purchased by an insurer to transfer part of its own risk to another insurer.", "tái bảo hiểm", "NOUN", "READING / CASE STUDY"],
    ["Exposure unit", "A measurable item, person or activity exposed to loss and used in pooling similar risks.", "đơn vị rủi ro", "NOUN PHRASE", "READING / CASE STUDY"],
    ["Peril", "A direct cause of loss, such as fire, collision or theft.", "hiểm họa; nguyên nhân trực tiếp gây tổn thất", "NOUN", "READING / CASE STUDY"],
    ["Pecuniary benefit", "A benefit that can be measured in money.", "lợi ích có thể định lượng bằng tiền", "NOUN PHRASE", "READING / CASE STUDY"]
  ],
  "unit-10": [
    ["Levy a tax", "To officially impose or collect a tax.", "đánh hoặc thu thuế", "COLLOCATION", "VOCABULARY EXERCISE"],
    ["Deduct from taxable income", "To subtract an allowable amount before tax is calculated.", "khấu trừ khỏi thu nhập chịu thuế", "COLLOCATION", "VOCABULARY EXERCISE"],
    ["File a tax return", "To submit an official statement of income, deductions and tax due.", "nộp tờ khai thuế", "COLLOCATION", "VOCABULARY EXERCISE"],
    ["Declare income", "To report income to the tax authority.", "khai báo thu nhập", "COLLOCATION", "VOCABULARY EXERCISE"],
    ["Be liable for tax", "To have a legal obligation to pay tax.", "có nghĩa vụ nộp thuế", "ADJECTIVE PHRASE", "VOCABULARY EXERCISE"],
    ["Tax-exempt", "Legally free from a particular tax.", "được miễn thuế", "ADJECTIVE", "VOCABULARY EXERCISE"],
    ["Apply for a tax refund", "To formally request repayment of tax paid in excess.", "xin hoàn thuế", "COLLOCATION", "VOCABULARY EXERCISE"],
    ["Tax bracket", "A range of income taxed at a particular rate.", "khung thuế suất", "NOUN PHRASE", "READING / CASE STUDY"],
    ["Tax rebate", "A reduction or repayment of tax granted under specified conditions.", "khoản giảm hoặc hoàn thuế", "NOUN PHRASE", "READING / CASE STUDY"],
    ["Accrued income", "Income earned during a period but not yet received.", "thu nhập dồn tích", "NOUN PHRASE", "READING / CASE STUDY"],
    ["Tax due", "The amount of tax legally payable by a stated date.", "thuế đến hạn", "NOUN PHRASE", "READING / CASE STUDY"],
    ["Taxpayer", "A person or organization legally required to pay tax.", "người nộp thuế", "NOUN", "READING / CASE STUDY"],
    ["Tax remitter", "A party required to collect or withhold tax and send it to the tax authority.", "bên khấu trừ và nộp thay thuế", "NOUN PHRASE", "READING / CASE STUDY"],
    ["Double taxation", "The taxation of the same income or profit twice, often by two jurisdictions.", "đánh thuế hai lần", "NOUN PHRASE", "READING / CASE STUDY"],
    ["Tax relief", "A deduction, credit, exemption or other measure that reduces tax liability.", "ưu đãi hoặc giảm nhẹ thuế", "NOUN PHRASE", "READING / CASE STUDY"],
    ["Avoid tax", "To lawfully arrange affairs to reduce tax liability.", "tránh thuế hợp pháp", "COLLOCATION", "READING / CASE STUDY"],
    ["Evade tax", "To illegally conceal or misrepresent information to avoid paying tax.", "trốn thuế", "COLLOCATION", "READING / CASE STUDY"],
    ["Impose a penalty", "To officially apply a punishment, fine or additional charge.", "áp dụng hình phạt", "COLLOCATION", "READING / CASE STUDY"],
    ["Close a loophole", "To change a rule so that an unintended legal gap can no longer be exploited.", "bịt lỗ hổng pháp lý", "COLLOCATION", "READING / CASE STUDY"],
    ["Assess tax liability", "To determine the amount of tax a person or organization owes.", "xác định nghĩa vụ thuế", "COLLOCATION", "READING / CASE STUDY"]
  ]
};

const normalizeVocabularyTerm = value => String(value)
  .toLowerCase()
  .replace(/\([^)]*\)/g, " ")
  .replace(/[^a-z0-9]+/g, " ")
  .trim();
...
window.ESP3_DATA.units.forEach(unit => {
  const existing = new Set(unit.terms.map(term => normalizeVocabularyTerm(term[0])));
  (ESP3_EXTENDED_VOCABULARY[unit.id] || []).forEach(entry => {
    const key = normalizeVocabularyTerm(entry[0]);
    if (!existing.has(key)) {
      unit.terms.push(entry);
      existing.add(key);
    }
  });
});
